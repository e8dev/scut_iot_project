  ...
  async uploadImgOne(im_path){
    ...
    NetInfo.fetch().then(state => {
      ...
      if(state.isConnected){
        ...
        var full_url = "http://dev2.rusrocket.com/test/api-photo-identify";
        ...
        .then((response) => {
          ...
          if(data && data.success && data.success==true){
            ...
            var input_name = data.data.name;
            var input_email = data.data.email;
            var input_phone = data.data.phone;

            alert("Success! Name: " + input_name + ", Email: " + input_email + ", Phone: " + input_phone);
      ...
      return (
        <View style={[styles.footer, this.isIphoneXorAbove() ? {alignItems: "flex-start", paddingTop:Metrics.HEIGHT*0.015} : null ]}>
          ...
          <TouchableOpacity style={styles.footerButtonWrapper} onPress={() => { this.props.navigation.navigate("TestLogin"); }} >
            ...
            />
            <Text style={[styles.footerButtonText,{color: "#ab5280"}]}>Test</Text>
          </TouchableOpacity>
      ...
      <SafeAreaView style={styles.container} forceInset={{ top: 'never' }}>
        ...
        <View style={styles.header}>
            ...
            <View style={[styles.headerCenter,{width: Metrics.WIDTH}]}>
              <Text style={[styles.headerScreenName,{color:"#ab5280"}]}>QuickPass Test Screen</Text>
            </View>
        ...
        <View style={[styles.content, {backgroundColor: "#fff"}]}>
          ...
          <KeyboardAwareScrollView enableOnAndroid={true} contentContainerStyle={{ justifyContent: "center" }}>
                ...
                <Text style={[styles.headerScreenName,{color:"#ab5280",textAlign:"center",fontSize: 18}]}>SomeApp ask you to login via QuickPass</Text>
                <View style={{ height: 20 }} />
